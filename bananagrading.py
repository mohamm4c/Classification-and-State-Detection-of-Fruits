...
path='C:/Users/qadri/Desktop/major project/program/Machine Learning A-Z Template Folder/Part 3 - Classification/Section 16 - Support Vector Machine (SVM)/dataset/banana grading'
...
labels = pd.read_csv(path1+"/labelsbanana.csv",index_col=0)
convert_Image(path)
csvEmpty()    
